        ...
        <div className="min-h-screen bg-gray-100 dark:bg-zinc-950 flex items-center justify-center p-4 transition-colors">
            <div className="w-full max-w-105 bg-white dark:bg-zinc-900 rounded-3xl shadow-xl dark:shadow-zinc-900 px-8 py-10 border border-transparent dark:border-zinc-800">
                ...
                <p className="text-center text-sm text-gray-400 dark:text-zinc-500 mb-7"
                    style={{ fontFamily: "'DM Sans', sans-serif" }}>
                    Join MediQueue today to start booking.
                </p>
                ...
                <Form onSubmit={onSubmit} className="flex flex-col gap-3">
                    ...
                    {/* Full Name */}
                    <TextField isRequired name="name" validate={validateName} className="w-full">
                    ...
                    {/* Photo URL */}
                    <TextField name="photoURL" isRequired validate={validatePhotoURL} className="w-full">
                        <div className="relative">
                            <span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 dark:text-zinc-500">
                                <PhotoIcon />
                            </span>
                ...
                <p className="text-center text-sm text-gray-400 dark:text-zinc-500 mt-6"
                    ...
                    <Link href="/login" className="text-[#4f35e8] dark:text-indigo-400 font-semibold hover:underline">
                        Log in here
                    </Link>
                </p>
            </div>
